...
import { Briefcase, Eye, EyeOff, Sparkles, ArrowRight, Building2 } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-white/40">
            Join 850+ companies hiring top talent
          </p>
        </div>
        ...
        <Card className="border border-white/10 bg-white/[0.03] backdrop-blur-sm shadow-2xl">
          <CardHeader className="text-center border-b border-white/10 pb-6">
            ...
            <CardTitle className="text-2xl text-white">Register as Employer</CardTitle>
          ...
          <CardContent className="pt-6">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                <Label htmlFor="companyName" className="text-white/60 text-xs font-medium uppercase tracking-wider">
                  Company name
                </Label>
                <Input 
                  id="companyName" 
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent className="border-white/10 bg-[#0b0c0e] text-white">
                    <SelectItem value="technology" className="focus:bg-white/10 focus:text-white">Technology</SelectItem>
                    <SelectItem value="finance" className="focus:bg-white/10 focus:text-white">Finance</SelectItem>
                    <SelectItem value="healthcare" className="focus:bg-white/10 focus:text-white">Healthcare</SelectItem>
                    <SelectItem value="education" className="focus:bg-white/10 focus:text-white">Education</SelectItem>
