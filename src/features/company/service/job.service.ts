...
export interface Job {
  ...
  created_at: string;
  updated_at: string;
  // Joined fields for public listing
  company?: {
    id: string;
    company_name: string;
    avatar_url: string;
...
export type JobInput = Omit<Job, 'id' | 'company_id' | 'applications_count' | 'created_at' | 'updated_at'>;

class JobService {
  // For company admin: get jobs without company details
