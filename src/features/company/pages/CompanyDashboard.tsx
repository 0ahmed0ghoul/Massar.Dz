              ...
              <Link to="/company/talent/ai-match">
                <div className="flex cursor-pointer items-center gap-3 rounded-xl border border-white/[0.08] bg-white/[0.02] p-3 transition-all hover:border-[#639922]/30 hover:bg-white/[0.05]">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-foreground/40">Find top 10 matches per job</p>
                  </div>
            ...
            >
              ...
              <div className="mb-3 flex flex-wrap gap-1.5">
                {topCandidate.skills.slice(0, 3).map((skill) => (
                  <span
                    key={skill}
                    className="rounded-full border border-white/[0.08] bg-white/[0.06] px-2 py-0.5 text-[10px] text-foreground/55"
                  >
                    {skill}
                  </span>
                ))}
                ...
                {recentApps.map((app) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#639922] to-[#3B6D11] text-xs font-bold text-foreground">
                        {app.candidateInitials}
                      </div>
                      <div>
                        <p className="font-medium text-foreground">{app.candidateName}</p>
                        <p className="text-xs text-foreground/40">Applied for {app.jobTitle}</p>
                      </div>
                    </div>
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-xs text-foreground/40">AI Match: {app.aiMatchScore || '—'}%</span>
                      <Badge
                        className={
