  ...
  return (
    <div className="relative min-h-screen bg-[#0b0c0e]">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white sm:text-4xl">Talent Database</h1>
          <p className="mt-1 text-sm text-white/40">Search, filter, and match candidates with AI.</p>
        </div>
        ...
        <div className="group mb-6 rounded-2xl border border-white/[0.09] bg-white/[0.03] backdrop-blur-md transition-all duration-300 hover:border-[#639922]/30">
          <div className="p-5 sm:p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-white">Filter Candidates</h2>
            </div>
            ...
            <Button onClick={handleSearch} className="mt-5 bg-[#639922] text-white hover:bg-[#4f7a1a]">
        ...
        <div className="group mb-6 rounded-2xl border border-white/[0.09] bg-white/[0.03] backdrop-blur-md transition-all duration-300 hover:border-[#639922]/30">
          <div className="p-5 sm:p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-white">AI Candidate Matching</h2>
            </div>
            <div className="space-y-4">
              <div className="flex flex-col gap-3 sm:flex-row">
                <select
                  ...
                  className="flex-1 rounded-md border border-white/20 bg-white/10 p-2 text-white"
                >
              ...
              {aiResults.length > 0 && (
                <div className="mt-4 space-y-3">
                  <p className="text-sm text-white/60">Showing {aiResults.length} candidates:</p>
                  {aiResults.map((c) => (
        ...
        <div className="group rounded-2xl border border-white/[0.09] bg-white/[0.03] backdrop-blur-md transition-all duration-300 hover:border-[#639922]/30">
          <div className="p-5 sm:p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="text-sm text-white/40">{searchResults.length} candidates</span>
            </div>
            <div className="space-y-3">
              ...
              {searchResults.length === 0 && (
                <p className="py-6 text-center text-sm text-white/40">No candidates match your filters.</p>
              )}
            </div>
          </div>
        </div>
